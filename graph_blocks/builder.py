...
class GraphConvolutionBS(Module):
    ...
    def __init__(self, in_features, out_features, activation_type='relu',
                withbn=False, withloop=False, bias=True,
                res=False, withweight=True):
        """
        Initial function.
...
class GraphBaseBlock(Module):
    ...
    def __init__(self, in_features, out_features, nbaselayer,
                 withbn=True, withloop=True, withweight=True, activation_type='relu',
                 dropout=0, aggrmethod="concat", bias=True,
                 res=False, dense=False):
        """
    ...
    def __makehidden(self):
        ...
        for i in range(self.nhiddenlayer):
            if i == 0:
                layer = GraphConvolutionBS(self.in_features, self.hiddendim, self.activation_type, self.withbn,
                                           self.withloop, self.bias, self.res, self.withweight)
            else:
                layer = GraphConvolutionBS(self.hiddendim, self.hiddendim, self.activation_type, self.withbn,
                                            self.withloop, self.bias, self.res, self.withweight)
...
class MultiLayerGCNBlock(Module):
    ...
    def __init__(self, in_features, out_features, nbaselayer,
                 withbn=True, withloop=True, activation_type='relu', dropout=0,
                 aggrmethod=None, dense=False, bias=True, withweight=True,
                 ):
        """
    ...
    def forward(self, inputs):
        ...
        return self.model.forward(input, adj), adj
...
class Dense(Module):
    ...
    def __init__(self, in_features, out_features, activation_type='relu', bias=True, res=False):
